...
void MoebiusDeformation3D::Interpolate(double t, int NumIterations)
{
    ...
    VectorXd InitialMobCoeffs=hedra::optimization::EigenSingleSolveWrapper<Eigen::SparseQR<Eigen::SparseMatrix<double, Eigen::ColMajor>, Eigen::COLAMDOrdering<int> > >(CompMatVar.adjoint()*CompMatVar,CompMatVar.adjoint()*Rhs, false);
